...
last_name = "Dhanraj"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "8287337060"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Ahmedabad"                  # Los Angeles, San Francisco, etc.
'''
